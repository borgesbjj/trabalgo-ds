        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-6xl font-bold mb-6">
              Descubra os Melhores Produtos de Tecnologia
            </h1>
            <p className="text-xl md:text-2xl mb-8 text-blue-100">
              Encontre smartphones, laptops, acessórios e muito mais com os melhores preços e qualidade garantida.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Confira nossa seleção especial dos produtos mais populares e bem avaliados pelos nossos clientes.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                name: "João Santos",
                rating: 5,
                comment: "Comprei um laptop e chegou rapidinho. Muito satisfeito!"
              },
              {
                name: "Ana Costa",
                rating: 4,
                comment: "Bons preços e entrega rápida. Voltarei a comprar!"
              }
